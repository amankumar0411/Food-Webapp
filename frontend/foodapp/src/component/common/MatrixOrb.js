...
const LABELS = {
  ...
  listening: 'Listening to your order...',
  thinking: 'Processing Voice Order...',
};
...
export const MatrixOrb = ({
  ...
  level,
  size = 200,
  color = '#e23744', // App primary red color accent
  dots = 12,
  labels,
  className = '',
  onClick,
  ...
  return (
    ...
    >
      ...
      />
      <span role="status" aria-live="polite" className="small fw-bold mt-2" style={{ color: 'var(--text-color)', opacity: 0.85 }}>
